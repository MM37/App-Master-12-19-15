 ...
 */
public class Auto_LineFollow extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException{
        ...
        /*movement to line*/
           ...
           //sleep(2000);
            ...
            while (ods.getLightDetectedRaw() < (matColor + THRESHOLD))    //threshold determines difference between white tape and mat
                turn(0.2, 10);
            ...
            while(!touchPressed) {
                while (ods.getLightDetectedRaw() >= matColor + THRESHOLD && !touchPressed) {
                    move(0.2, 1);
                    sleep(100);
                    turn(0.3, -10);
                    sleep(100);
