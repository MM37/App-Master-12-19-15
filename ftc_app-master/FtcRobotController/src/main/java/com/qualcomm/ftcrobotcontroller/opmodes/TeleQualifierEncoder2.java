 ...
 */
public class TeleQualifierEncoder2 extends OpMode {
    ...
    */
    ...
    public double initialPulleyPosition;

    public TeleQualifierEncoder2() {
        /*empty*/
    }
    ...
    public void init(){
        ...
        initialPulleyPosition = pulleyMotor1.getCurrentPosition();
    }
    ...
    public void loop() {
        ...
        */
        ...
        if (abs(gamepad2.right_stick_y) > 0.08 && !(gamepad2.right_stick_y>0 && pulleyMotor1.getCurrentPosition()<=initialPulleyPosition)) {
